...
class Translator(object):
    ...
    def translate(self,
        ...
        if self.data_type == 'logic':
            data_iter = inputters.LOGICIterator(
    ...
    def _fast_translate_batch(self,
        ...
        assert data.data_type == 'text' or data.data_type == 'logic'
    ...
    def _translate_batch(self, batch, data):
        ...
        src_map = rvar(batch.src_map.data) \
            if data_type in ['text','logic'] and self.copy_attn else None
